...
# your turn
_=plt.scatter('Height', 'Weight', data=dflog, alpha=0.25, marker='o', c=[cmap_bold.colors[i] for i in dflog.Gender=="Male"])
_=plt.xlabel('Height')
_=plt.ylabel('Weight')
_=plt.title('Weight vs. Height scatter plot')
...
print('the accuracy of this model is higher than the accuracy of last model')
